...
<template>
  <div class="p-4">
    ...
    <div v-else-if="locations?.length" class="flex flex-nowrap mt-4 gap-2 overflow-auto">
      <div
        v-for="location in locations"
        :key="location.id"
        class="card card-compact bg-base-300 h-40 w-72 shrink-0 border-2 cursor-pointer mb-2"
        :class="{
