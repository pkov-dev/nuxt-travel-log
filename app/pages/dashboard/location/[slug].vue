...
<template>
  <div class="page-content-top">
      ...
      <h2 class="text-xl">
        ...
        <div class="dropdown dropdown-bottom">
          <div
            tabindex="0"
            role="button"
            class="btn m-0 btn-sm p-0 border-transparent"
          >
    ...
    >
      ...
      >
        <template #top>
          <span v-if="locationLog.startedAt !== locationLog.endedAt" class="text-sm text-gray-500 italic">
    ...
    <AppDialog
      ...
      confirm-label="Yes, I delete this location"
